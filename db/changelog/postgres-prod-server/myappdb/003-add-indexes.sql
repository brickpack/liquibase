...
--changeset myapp-team:003-add-performance-indexes runInTransaction:false
...
--changeset myapp-team:003-add-search-column runInTransaction:false
...
--changeset myapp-team:003-add-search-function
...
--changeset myapp-team:003-add-audit-table
...
--changeset myapp-team:003-add-audit-function splitStatements:false
